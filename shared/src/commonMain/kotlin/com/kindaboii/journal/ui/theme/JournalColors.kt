...
internal object JournalColors {
    ...
    val SecondaryDark = Color(0xFF5F3C69)
    val BackgroundDark = Color(0xFF0C0F1F)
    val BackgroundOnDark = Color(0xFFF1ECF6)
    val SurfaceDark = Color(0xFF362644)
    val SurfaceOnDark = Color(0xFFF1ECF6)
