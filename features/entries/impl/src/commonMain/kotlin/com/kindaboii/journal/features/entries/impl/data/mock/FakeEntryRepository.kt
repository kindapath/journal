...
//
//    override fun getEntries(): List<Entry> = entries.sortedByDescending { it.createdAt }
//
//    override fun getEntryById(id: String): Entry? = entries.firstOrNull { it.id == id }
//
...
//    }
//
//    override fun deleteEntryById(id: String) {
...
//    }
//
//    override fun replaceAll(entries: List<Entry>) {
//        this.entries.clear()
//        this.entries.addAll(entries)
//    }
//
//    private fun upsertEntry(entry: Entry) {
//        entries.removeAll { it.id == entry.id }
//        entries.add(entry)
//    }
//
//    private fun seedEntries(): List<Entry> =
//        listOf(
//            Entry(
//                id = "1",
